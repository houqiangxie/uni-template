 ...
 * @LastEditTime: 2023-08-08 09:29:24
-->
...
<template>
  <div>
    ...
    <p my-2>
      <span cursor-pointer @click="router.push('https://github.com/Ares-Chang/uni-vitesse')">Uni Vitesse</span>
    </p>
    <p>
      <em text-sm italic op75>Opinionated Vite Starter Template</em>
    </p>
  </div>
</template>
