class Calendar {
  ...
  getNextMonthObj(date){
	...
	getPreMonthDays(amount, dateObj) {
		...
		for (let i = amount - 1; i >= 0; i--) {
			...
			let date = new Date(dateObj.year, month, -i).getDate();
  ...
  */
	...
	// 			isToday: false,
	// 			disable: true,
	// 			disableChecked: (this.startDate && !dateCompare(this.startDate, fullDate)) || (this.endDate && !dateCompare(fullDate, this.endDate)),
	// 			userChecked: false,
