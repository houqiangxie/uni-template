	...
	<view class="uni-date">
        ...
        >
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						...
						<view :class="`uni-date__x-input ${displayValue?'text-[#262626]':'text-[#bfbfbf]'}`">{{ displayValue || singlePlaceholderText }}</view>
					</view>

					<view v-else class="uni-date-x uni-date-range">
            <!-- <uni-icons class="icon-calendar" type="calendar" color="#c0c4cc" size="22"></uni-icons> -->
            <view :class="`uni-date__x-input ${displayRangeValue.startDate ?'text-[#262626]':'text-[#bfbfbf]'} text-center`">{{ displayRangeValue.startDate || startPlaceholderText }}{{ rangeSeparator }}{{ displayRangeValue.endDate || endPlaceholderText }}</view>

            <!-- <view :class="`range-separator ${displayValue?'text-[#262626]':'text-[#bfbfbf]'}`">{{rangeSeparator}}</view>

            <view :class="`uni-date__x-input ${displayValue?'text-[#262626]':'text-[#bfbfbf]'} text-center`">{{ displayRangeValue.endDate || endPlaceholderText }}</view> -->
					</view>

					<view v-if="showClearIcon" class="uni-date__icon-clear" @click.stop="clear">
						<wd-icon name="close" size="22" color="#c0c4cc"/>
					</view>
				</view>
			</slot>
		</view>
